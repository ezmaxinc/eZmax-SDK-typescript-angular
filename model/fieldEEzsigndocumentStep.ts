 ...
 */
export type FieldEEzsigndocumentStep = 'Unsent' | 'Unsigned' | 'PartiallySigned' | 'DeclinedToSign' | 'PrematurelyEnded' | 'Completed';
...
export const FieldEEzsigndocumentStep = {
    ...
    DeclinedToSign: 'DeclinedToSign' as FieldEEzsigndocumentStep,
    PrematurelyEnded: 'PrematurelyEnded' as FieldEEzsigndocumentStep,
